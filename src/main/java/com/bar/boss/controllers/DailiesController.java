...
import com.bar.validators.SearchDatesFormValidator;
...
public class DailiesController {
	...
	public ModelAndView searchCalculateDailies() {
		...
		model.addObject("searchDailyForm", new SearchDatesForm());
		return model;
	}
	...
	public ModelAndView searchDaily(@ModelAttribute("searchDailyForm") SearchDatesForm sdf, BindingResult arg1) {
		ModelAndView model;
	...
	public ModelAndView calculateDailies(@ModelAttribute("searchDailyForm") SearchDatesForm sdf,
